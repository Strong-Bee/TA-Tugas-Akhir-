	...
	<header class="app-header fixed-top">
		...
		<div id="app-sidepanel" class="app-sidepanel">
			...
			<div class="sidepanel-inner d-flex flex-column">
				...
				<nav id="app-nav-admin" class="app-nav app-nav-main flex-grow-1">
					<ul class="app-menu list-unstyled accordion" id="menu-accordion">
						...
						<!-- Manajemen Pengajuan -->
						<li class="nav-item">
							<a class="nav-link" href="pengajuan-cuti.html">
								<span class="nav-icon"><i class="fas fa-file-signature"></i></span>
								<span class="nav-link-text">Pengajuan Cuti</span>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="pengajuan-lembur.html">
								<span class="nav-icon"><i class="fas fa-clock"></i></span>
								<span class="nav-link-text">Pengajuan Lembur</span>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="pengajuan-sakit.html">
								<span class="nav-icon"><i class="fas fa-notes-medical"></i></span>
								<span class="nav-link-text">Pengajuan Sakit</span>
							</a>
						</li>
						<!-- Laporan -->
						<li class="nav-item">
