	...
	<header class="app-header fixed-top">
		...
		<div id="app-sidepanel" class="app-sidepanel">
			...
			<div class="sidepanel-inner d-flex flex-column">
				...
				<nav id="app-nav-superadmin" class="app-nav app-nav-main flex-grow-1">
					<ul class="app-menu list-unstyled accordion" id="menu-accordion">
						...
						<li class="nav-item">
							<a class="nav-link" href="data-admin.html">
						...
						<li class="nav-item">
							<a class="nav-link" href="pengajuan.html">
								...
								<span class="nav-link-text">Semua Pengajuan</span>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="laporan.html">
								<span class="nav-icon"><i class="fas fa-chart-pie"></i></span>
								<span class="nav-link-text">Laporan & Statistik</span>
							</a>
						</li>
						<!-- Pengaturan Sistem -->
						<li class="nav-item">
							<a class="nav-link" href="pengaturan.html">
								...
								<span class="nav-link-text">Pengaturan Sistem</span>
							</a>
						</li>
						<!-- Logout -->
						<li class="nav-item">
